...
public class OpenApiController {
	   ...
	   String OpenApiInsert(Model model, CompanyVO vo) throws Exception {
		   StringBuilder urlBuilder = new StringBuilder("http://apis.data.go.kr/6480000/gyeongnamgoodemploycompany/gyeongnamgoodemploycompanylist"); /*URL*/
	        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=54SkmUmzIJi50HjBbf4xo6djul7W1FqrjNywdG34oDohy4BoND56PoM7i%2FwbubxcIvvbzhdNxOlNh9CkMCVWlg%3D%3D"); /*Service Key (일반인증키)*/
	   ...
	   @RequestMapping("/listcompany.do")
		String listcompany(Model model, CompanyVO vo) {
			model.addAttribute("li",service.listcompany(vo));
			return "/shop/company_selectAll.jsp";
		}
	   ...
	   @RequestMapping("/listev.do")
			String listev(Model model, EvSearchVO vo) {
		   System.out.println("=============evsearchVO22"+vo);
				model.addAttribute("li",service.listev(vo));
				return "/shop/ev_selectAll.jsp";
			}
	   
	   
	   @RequestMapping("/OpenSelectonecompany.do")
			String OpenSelectonecompany(Model model, CompanyVO vo) {
				model.addAttribute("m", service.onecompany(vo));
				return "/openAPI/company_selectOne.jsp";
			}
	   
	   @RequestMapping("/OpenSelectev.do")
			String OpenSelectev(Model model, EvSearchVO vo) {
				model.addAttribute("li", service.listev(vo));
				return "/openAPI/ev_selectAllMap.jsp";
			}
	   
	   @RequestMapping("/OpenSelectoneev.do")
			String OpenSelectoneev(Model model, EvSearchVO vo) {
				model.addAttribute("m", service.oneev(vo));
