<%@ page language="java" pageEncoding="UTF-8"%>
 ...
 <div align=center>
 <h2> 회원목록 페이지</h2>
 <form onSubmit="return formCh()" action="${path}/insert.do">
<table border=1>
<tr><td>회원번호</td><td><input type=text name=custno value="${custno}"></td></tr>
 <tr><td>아 이 디 </td><td><input  type="text" name="id"  id="id" >
...
<tr><td>가입날짜</td><td><input type=text name=joindateStr value="${sysYear}"></td></tr>
<tr><td>회원등급</td><td>
